    ...
    <div className="w-full bg-white py-3">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex gap-3 items-stretch">
          {/* Static Ad — takes ~70% width */}
          <div
            className="relative flex-[2.8] group cursor-pointer rounded-lg overflow-hidden shadow-md border border-gray-200 bg-gradient-to-br from-orange-500 to-red-600 min-w-0 flex flex-col items-center justify-center text-center p-2"
          ...
          {/* Video Ad — takes ~35% width */}
          <div
            className="relative flex-[1.4] group cursor-pointer rounded-lg overflow-hidden shadow-md border border-gray-200 bg-black min-w-0 h-48 md:h-60"
          ...
          >
            ...
            <div className="absolute bottom-2 left-2 right-2">
              <p className="text-white font-bold text-xs md:text-sm drop-shadow-lg bg-black/50 px-2 py-1 rounded">
                {ad.title}
              </p>
            </div>
          </div>

...
export const Subscription = ({ inModal = false, onClose }: SubscriptionProps) => {
  ...
  return (
    <div className={inModal ? "w-full max-w-xl mx-auto p-6" : "min-h-screen bg-gray-50 py-12"}>
      {!inModal && (
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 border border-gray-100">
          {onClose && (
            <div className="flex justify-end mb-3">
              <button
                onClick={onClose}
                className="text-lg text-gray-500 hover:text-gray-700 leading-none"
                aria-label="Close"
              >
                ×
              </button>
          ...
          {!isSubmitted ? (
            <>
              ...
              <p className="text-gray-600 text-sm mb-6">
                You will receive updates whenever a new article is posted.
              </p>
              ...
              <div className="text-center">
                <p className="text-xs text-gray-400">We will never charge you or share your email.</p>
              </div>
            </>
          ) : (
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">We will notify you whenever a new article is uploaded.</p>
              <Button
                variant="ghost"
                className="mt-6"
                onClick={() => {
